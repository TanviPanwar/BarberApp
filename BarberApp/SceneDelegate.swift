...
class SceneDelegate: UIResponder, UIWindowSceneDelegate, CLLocationManagerDelegate, GMSMapViewDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        if apiToken is String {
            ...
            let viewController  = mainStoryBoard.instantiateViewController(identifier: "TabBarVcViewController") as! TabBarVcViewController //ViewController = Name of your controller
